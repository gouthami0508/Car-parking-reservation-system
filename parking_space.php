...
<form class="box login" action="process-book-2.php" method="post">
	...
	<hr />
	   ...
	   <select name="street" class="cjComboBox" >
			<option value="DN nagar street">DN nagar street</option>
			<option value="Amboli naka">Amboli naka</option>
			<option value="R mall">R mall</option>
			<option value="Infiniti mall">Infiniti mall</option>
			<option value="Rinci motors">Rinci motors</option>
		</select>
	...
	<label>Plate Number</label>
	  <input type="text" tabindex="3" name="plateno" placeholder="eg. MH 7838" required>
